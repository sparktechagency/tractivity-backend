...
missionRouter.get(
  '/retrive/creator/:creatorId',
  authorization('super-admin', 'admin', 'user'),
  missionControllers.retriveMissionsByCreatorId,
);
...
missionRouter.get(
  ...
  authorization('super-admin', 'admin', 'user'),
  missionControllers.retriveMissionsByOrganization,
);
missionRouter.get(
  '/retrive/organization/report/:organizationId',
  authorization('super-admin', 'admin', 'user'),
  missionControllers.retriveAllMissionsReportByOrganization,
);

missionRouter.delete(
  '/remove/organizer/:missionId',
  authorization('super-admin', 'admin', 'user'),
  missionControllers.removeOrganizerFromMission,
);
